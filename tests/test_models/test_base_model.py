...
class TestBaseModel(unittest.TestCase):
    ...
    def trial_base_model_docstrings(self):
    ...
    def trial_Instatiation_kwags(self):
    ...
    def trial_base_model_str(self):
        bm = BaseModel()
        self.assertEqual(str(bm), "[BaseModel] ({}) {}".
                         format(bm.id, bm.__dict__))

    def trial_basemodel_save(self):
        bm = BaseModel()
    ...
    def trial_basemodel_to_dict(self):
        bm = BaseModel()
        bm_dict = bm.to_dict()
